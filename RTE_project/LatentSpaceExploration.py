...
print('Linear regression of temperature for VAE Conv: ')
print(regression_temp(ClementVAE_Conv1D.encoder, ClementVAE.x_train, conditioned=False))
...
print('MLP classifier of days for VAE Conv: ')
print(classifier_day(ClementVAE_Conv1D.encoder, ClementVAE.x_train, conditioned=False))
...
scatter_plot_latent_space(ClementVAE_Conv1D.encoder, ClementVAE.x_train, 0, 1, conditioned=False)

...
value_mse_score = scoring.MSE(X_val[:, :48], median[:, :48])
...
value_mse_score_vae = scoring.MSE(X_val[:, :48], median_vae[:, :48])
...
value_mse_random = scoring.MSE(X_val[:,:48], scenarios_random[:,50,:])

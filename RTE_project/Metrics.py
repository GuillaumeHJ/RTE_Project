...
train_dataloader, val_dataloader, test_dataloader, training_cond, validation_cond, test_cond = Load_data.load(path, False)
train_cond_dataloader, val_cond_dataloader, test_cond_dataloader, training_set, validation_set, test_set = Load_data.load(path, True)
